 ...
 */
    public function saveToolConsumer($consumer)
    {
        ...
        if ($ok) {
            if (empty($id)) {
                $consumer->setRecordId(mysqli_insert_id());
 ...
 */
    public function saveContext($context)
    {
        ...
        if ($ok) {
            if (empty($id)) {
                $context->setRecordId(mysqli_insert_id());
 ...
 */
    public function saveResourceLink($resourceLink) {
        ...
        if ($ok) {
            if (empty($id)) {
                $resourceLink->setRecordId(mysqli_insert_id());
 ...
 */
    public function saveUser($user)
    {
        ...
        if ($ok) {
            if (is_null($user->created)) {
                $user->setRecordId(mysqli_insert_id());
                $user->created = $time;
            }
            $user->updated = $time;
        }
